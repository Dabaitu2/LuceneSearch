...
@WebServlet(name = "JwSearchServlet")
public class JwSearchServlet extends HttpServlet {
...
//        String aidSearch = school.equals("全部") ? "" : " AND (school_name:" + school+")";
        List<JSONObject> rst = tjdbc.search(sort, query, true, Integer.parseInt(page), school, "jw");
